...
namespace Курсовая
{
        ...
        public static List<Activity> allActs = new List<Activity>
    {
        //Активности
            ...
            //1
            new Activity("Парк Горького", "https://www.parkperm.ru/", "утро/день и вечер и весь день", "досуг с детьми и активности", "Пермский парк Горького" +
            ...
            //7
            new Activity("Экскурсия на шоколадную фабрику", "https://candyfactoryperm.com/jekskursii/", "утро/день и вечер и весь день", "экскурсии",
            ...
            //9
            new Activity("Мегалэнд", "https://megalandpark.ru/perm", "утро/день и весь день", "досуг с детьми", "Мегалэнд - это увлекательный парк развлечений, где каждый найдет что-то " +
            ...
            //24
            new Activity("Экскурсия в ботанический сад ПГНИУ", "https://vk.com/botsad_perm", "утро/день и весь день", "экскурсии", "В настоящее время Ботанический сад имени " +
            ...
            //38
            new Activity("Активити парк Sky Trip", "https://skytrip.pro/", "утро/день и весь день", "досуг с детьми и активности", "«Активити парки Sky Trip» как" +
