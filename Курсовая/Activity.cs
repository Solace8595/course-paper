        ...
        public static List<Activity> allActs = new List<Activity>
    {
       ...
       new Activity("Пермский цирк", "https://www.circus-perm.ru/", "утро/день", "досуг с детьми", "Цирк - это захватывающее зрелище, где искусные артисты исполняют" +
           ...
           new Activity("Парк Горького", "https://www.parkperm.ru/", "утро/день и вечер", "досуг с детьми и активности", "Пермский парк Горького" +
            ...
            //4
            new Activity("Прогулка на лодочке", "https://vk.com/river_tram", "утро/день и вечер", "прогулки", "Прогулка на лодочке - это спокойное" +
                ...
                " от городской суеты и насладиться моментами умиротворения и гармонии.", 1000, "https://sportishka.com/uploads/posts/2022-03/1646867614_29-sportishka-com-p-kruiz-po-volge-" +
                "na-teplokhode-turizm-krasiv-36.jpg"),
            //5
            ...
            new Activity("Пермская эспланада", "https://www.tourister.ru/world/europe/russia/city/perm/squares/28088", "утро/день и вечер", "прогулка",
                ...
                "мероприятия; молодожены устраивают фотосессии, дети резвятся на детских площадках, а взрослые прогуливаются по променаду и отдыхают в кафе.", 0, "картнка"),
            //37
